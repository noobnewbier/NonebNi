...
{
    [CreateAssetMenu(fileName = nameof(CameraControlSetting), menuName = MenuName.Data + nameof(CameraControlSetting))]
    public class CameraControlSetting : ScriptableObject
    {
        ...
        [Range(0.1f, 20f), SerializeField]  private float maxDistanceToMap;
        ...
        public float MaxDistanceToMap => maxDistanceToMap;
